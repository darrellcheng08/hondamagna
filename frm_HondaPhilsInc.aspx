                                ...
                                <asp:View ID="View4" runat="server">
                                    ...
                                    <div>
                                        ...
                                        <table class="style1">
                                            ...
                                            <tr>
                                                <td class="style44">
                                                    <asp:Button ID="btn_UnitDelColor" runat="server" Text="Delete Color" OnClick="btn_UnitDelColor_Click" OnClientClick="return false"/>
                                                </td>
                                                <td>
                                ...
                                <asp:MultiView ID="MultiView9" runat="server">
                                    <asp:View ID="View24" runat="server">
                                        <table class="style1">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:GridView ID="grid_BillingA" runat="server" 
                                                        style="text-align: center" Width="689px">
                                                    </asp:GridView>
                                                    <table class="style1">
                                                        <tr>
                                                    ...
                                                    <asp:Label ID="lbl_Adde" runat="server" Text="Added Item/s to this P.O. :" 
                                                        Visible="False"></asp:Label>
                                                    <asp:GridView ID="grid_BillingB" runat="server" 
                                                        style="text-align: center" Width="689px">
                                                    </asp:GridView>
                                                </td>
                                            </tr>
            ...
            <div>&nbsp;<h1>
                ...
                <table class="style1">
                        <tr>
                                ...
                                <div>
                                    <table class="style1">
                                        <tr>
                                            <td>
                                                ...
                                                <asp:Button ID="btn_FilesUploaded" runat="server" Text="Files Received" 
                                                    onclick="btn_FilesUploaded_Click" />
                                            </td>
                                        </tr>
                                    </table>
                                    <asp:MultiView ID="MultiView10" runat="server">
                                        ...
                                        <asp:View ID="View29" runat="server">
                                            <br />
                                            Sent<asp:GridView ID="grid_SentM" runat="server" AutoGenerateSelectButton="True" 
                                                Style="text-align: center" Width="466px" BackColor="White" 
                                                BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" 
                                                ForeColor="Black" GridLines="Horizontal" 
                                                onselectedindexchanged="grid_SentM_SelectedIndexChanged">
                                            ...
                                            <asp:Button ID="btn_SeleteAllSent" runat="server" 
                                                onclick="btn_SeleteAllSent_Click" Text="Delete All" />
                                        </asp:View>
                                        ...
                                        <asp:View ID="View31" runat="server">
                                            <asp:GridView ID="grid_Files" runat="server" 
                                                ...
                                                onrowcommand="grid_Files_RowCommand" onrowdeleting="grid_Files_RowDeleting">
                                                <Columns>
                            ...
                            <td>
                                <div>
                                        To: Honda Magnacycle Sales Corp.&nbsp;Head Office<br /> From: Honda Philippines Inc.
                                    <table class="style1">
                                        <tr>
                                            <td>
